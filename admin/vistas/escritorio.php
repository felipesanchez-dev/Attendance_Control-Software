  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <h5 style="font-size: 20px;">
        <strong>Reporte de asistencia General</strong>
      </h5>
      <p>Módulo</p>
    </div>
    <div class="icon">
  ...
  <div class="small-box bg-orange">
    <div class="inner">
      <h4 style="font-size: 20px;">
        <strong>Usuarios Registrados existentes</strong>
      </h4>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  <div class="small-box bg-aqua">
    ...
    <div class="inner">
      <h5 style="font-size: 20px;">
        <strong>Reporte de asistencia por Usuario</strong>
      </h5>
      <p>Módulo</p>
    </div>
    <div class="icon">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  <div class="small-box bg-red">
    ...
    <div class="inner">
      <h5 style="font-size: 20px;">
        <strong>Reporte de asistencia por Fecha</strong>
      </h5>
      <p>Módulo</p>
    </div>
    <div class="icon">
