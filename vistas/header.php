...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="escritorio.php" class="logo">
      <span class="logo-mini"><b>CONTROL DE ENTRADA Y SALIDA</b></span>
      <span class="logo-lg"><b>CONTROL DE ENTRADA Y SALIDA</b> ADMIN</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="asistencia.php" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
...
<div class="user-panel">
      ...
      <li class="header">Barra de busqueda rapida</li>
      ...
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Menu de Acceso</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i>Sede de la CUN</a></li>
          </ul>
      </li>

      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Creacion de roles</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
